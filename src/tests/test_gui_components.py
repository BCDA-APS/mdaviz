...
class TestMainWindowBasic:
    ...
    def test_mainwindow_menu_accessibility(
        self, main_window: MainWindow, qtbot: "QtBot"
    ) -> None:
        """Test MainWindow menu accessibility."""
...
class TestChartViewBasic:
    ...
    def test_chartview_curve_management(self, chart_view: ChartView) -> None:
        ...
        chart_view.curveManager.addCurve(
            curve_id, "Test Curve", 1, 2, 3, 4, 5, [4, 5, 6, 7, 8]
        )
    ...
    @pytest.mark.skip(
        reason="Data tuple index out of range - needs proper test data setup"
    )
...
class TestMemoryManagementUI:
    ...
    def test_cache_eviction(self, qapp: QApplication, qtbot: "QtBot") -> None:
        ...
        cache.put(
            "key3", CachedFileData(data="data3", file_path="key3")
...
def test_mda_file_viz_log_scale_functionality(
