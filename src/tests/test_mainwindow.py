...
class TestMainWindow:
    ...
    def test_mainwindow_creation(self, qapp: QApplication, qtbot: QtBot) -> None:
        ...
        with patch("mdaviz.mainwindow.settings.getKey") as mock_settings:
            ...
            def mock_get_key(key: str) -> str | int:
                if key == "directory" or "recentFolders" in key:
    ...
    def test_mainwindow_creation_simple(self, qapp: QApplication) -> None:
        """Test that MainWindow can be created without QtBot."""
        with patch("mdaviz.mainwindow.settings.getKey") as mock_settings:
