...
class TestMainWindowResizing:
    ...
    def test_setup_resizable_layout_method(self):
        ...
        try:
            ...
            assert window.centralwidget.sizePolicy().horizontalPolicy() == QtWidgets.QSizePolicy.Expanding
            assert window.groupbox.sizePolicy().horizontalPolicy() == QtWidgets.QSizePolicy.Expanding
            assert window.widget.sizePolicy().horizontalPolicy() == QtWidgets.QSizePolicy.Expanding
    ...
    def test_ui_file_has_minimum_size(self):
        ...
        ui_file = Path(__file__).parent.parent / "mdaviz" / "resources" / "mainwindow.ui"
