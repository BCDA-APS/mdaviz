...
from mdaviz.data_cache import DataCache, CachedFileData, get_global_cache, set_global_cache
...
class TestDataCacheIntegration:
    ...
    def test_load_and_cache(self, mock_exists: "MockerFixture", mock_stat: "MockerFixture", mock_get_scan: "MockerFixture", mock_read_mda: "MockerFixture") -> None:
    ...
    @patch('pathlib.Path.stat')
    @patch('pathlib.Path.exists')
    def test_get_or_load_not_cached(self, mock_exists: "MockerFixture", mock_stat: "MockerFixture", mock_get_scan: "MockerFixture", mock_read_mda: "MockerFixture") -> None:
