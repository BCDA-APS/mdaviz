...
class TestLazyFolderScanner:
    ...
    def test_scan_folder_empty(self, scanner: LazyFolderScanner, temp_folder: Path) -> None:
    ...
    def test_scan_folder_with_files(self, scanner: LazyFolderScanner, temp_folder: Path) -> None:
    ...
    def test_scan_folder_too_many_files(self, scanner: LazyFolderScanner, temp_folder: Path) -> None:
    ...
    def test_scan_progress_callback(self, scanner: LazyFolderScanner, temp_folder: Path) -> None:
...
class TestDataCache:
    ...
    def test_cache_put_and_get(self, cache: DataCache, test_file_data: CachedFileData) -> None:
    ...
    def test_cache_clear(self, cache: DataCache, test_file_data: CachedFileData) -> None:
    ...
    def test_cache_stats(self, cache: DataCache, test_file_data: CachedFileData) -> None:
...
class TestVirtualTableModel:
    ...
    def test_model_initialization(self, virtual_model: VirtualTableModel, mock_data_provider: Mock) -> None:
    ...
    def test_row_count(self, virtual_model: VirtualTableModel, mock_data_provider: Mock) -> None:
        """Test getting row count."""
        assert virtual_model.rowCount() == 1000
        mock_data_provider.get_row_count.assert_called_once()
    
    def test_column_count(self, virtual_model: VirtualTableModel, mock_data_provider: Mock) -> None:
        """Test getting column count."""
        assert virtual_model.columnCount() == 5
        mock_data_provider.get_column_count.assert_called_once()
    
    def test_data_retrieval(self, virtual_model: VirtualTableModel, mock_data_provider: Mock) -> None:
    ...
    def test_header_data(self, virtual_model: VirtualTableModel) -> None:
        """Test getting header data."""
        header = virtual_model.headerData(0, QtCore.Qt.Horizontal, QtCore.Qt.DisplayRole)
        assert header == "Col1"
        
        row_header = virtual_model.headerData(0, QtCore.Qt.Vertical, QtCore.Qt.DisplayRole)
        assert row_header == "1"
    
    def test_set_visible_range(self, virtual_model: VirtualTableModel, mock_data_provider: Mock) -> None:
...
class TestMDAVirtualDataProvider:
    ...
    def test_provider_initialization(self, mda_provider: MDAVirtualDataProvider, test_scan_dict: Dict[str, Any]) -> None:
    ...
    def test_data_retrieval_out_of_bounds(self, mda_provider: MDAVirtualDataProvider) -> None:
...
class TestLazyLoadingConfig:
    ...
    def test_config_save_and_load(self, config: LazyLoadingConfig, tmp_path: Path) -> None:
