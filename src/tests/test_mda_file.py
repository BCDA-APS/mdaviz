...
class TestMDAFile:
    ...
    def test_mda_file_set_data_with_valid_file(self, qtbot: "FixtureRequest", tmp_path: Path) -> None:
    ...
    def test_mda_file_set_data_with_read_error(self, qtbot: "FixtureRequest", tmp_path: Path) -> None:
    ...
    def test_mda_file_cache_integration(self, qtbot: "FixtureRequest", tmp_path: Path) -> None:
        ...
        mock_cached_data.scan_dict = {"pos1": {"name": "Position 1", "values": [1, 2, 3]}}
    ...
    def test_mda_file_display_data(self, qtbot: "FixtureRequest") -> None:
        ...
        # Set some test data
        mda_file._data = {"scanDict": {"pos1": {"name": "Position 1", "values": [1, 2, 3]}}}
    ...
    def test_mda_file_clear_graph(self, qtbot: "FixtureRequest") -> None:
        ...
        with patch.object(mda_file.mda_mvc.mda_file_viz, 'plotPageMpl') as mock_plot_page:
            ...
            mock_curve_manager.removeAllCurves.assert_called_once_with(doNotClearCheckboxes=False)
