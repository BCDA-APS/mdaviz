...
class ProgressDialog(QtWidgets.QProgressDialog):
    ...
    def __init__(self, title: str = "Progress", parent: Optional[QtWidgets.QWidget] = None,
                 auto_close: bool = True, auto_reset: bool = True):
        """
...
class AsyncProgressDialog(ProgressDialog):
    ...
    def update_progress_async(self, current: int, total: int, message: str = "") -> None:
        """
