...
class MDAFile(QtWidgets.QWidget):
    ...
    def addNewTab(self, index, filePath=None, tableModel=None, label=None):
        """
        ...
        # if tab_list:
        #     self.tabWidget.addTab(self.file_tableview)
        #     self.tabWidget.setTabText(len(tab_list), self.fileName())
        # else:
        #     layout = self.TabWidget.layout()
        #     layout.addWidget(self.file_tableview)
        ...
        layout = self.TabWidget.layout()
        layout.addWidget(self.file_tableview)
        # layout.TabWidget.addTab(self.file_tableview)
